        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' https://vercel.live; frame-src https://vercel.live; style-src 'self' 'unsafe-inline'; object-src 'none';", // CSP ajustada
          },
          {
            key: "X-Frame-Options",
