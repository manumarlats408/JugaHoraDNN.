...
import { useRouter } from 'next/navigation'  // No necesitas `useSearchParams` si no vas a usar matchId
...
const AddPlayers = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Aquí deberías hacer algo con los jugadores seleccionados, como enviarlos al backend o almacenarlos temporalmente
